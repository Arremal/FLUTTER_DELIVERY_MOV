...
import 'file:///C:/Users/PARTNER05/AndroidStudioProjects/flutter_app_2/lib/Main/bodyn.dart';
              ...
              child: Row(
                children: <Widget>[
                  Padding(
                    ...
                    child: Image.asset("assest/calabaza.png",
                      height: 70.0,) ,
                  ),
                  Text("Vegetables",
                    style: TextStyle(
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.all(1.0),
                  child: Image.asset("assest/fastcomida.png",
                    height: 70.0,) ,
                ),
                Text("Fast food",
                  style: TextStyle(
